...
@implementation FSGPUImageFilterManager
@synthesize title,filterSettingsSlider,sourcePicture;

SINGLETON_GCD(FSGPUImageFilterManager);

- (UIActionSheet*)createSepiaCameraAppSheetWithDelegate:(id)delegate{
    ...
    UIActionSheet *filterActionSheet = [[UIActionSheet alloc] initWithTitle:@"Select Filter"
                                                     ...
                                                     destructiveButtonTitle:nil
                                                          otherButtonTitles:
                                        FILTERSTR(GPUIMAGE_SEPIA),
                                        FILTERSTR(GPUIMAGE_SKETCH),
                                        FILTERSTR(GPUIMAGE_VIGNETTE),
                                        FILTERSTR(GPUIMAGE_SMOOTHTOON),
                                        FILTERSTR(GPUIMAGE_POSTERIZE),
                                        FILTERSTR(GPUIMAGE_BULGE),
                                        FILTERSTR(GPUIMAGE_PINCH),
                                        FILTERSTR(GPUIMAGE_FASTBLUR),
                                        FILTERSTR(GPUIMAGE_COLORINVERT),
                                        FILTERSTR(GPUIMAGE_GRAYSCALE),
                                        FILTERSTR(GPUIMAGE_EMBOSS), nil];

    return filterActionSheet;
}

- (NSString*) stringNameOfFilter:(GPUImageShowcaseFilterType)filterType{
    ...
    switch (filterType)
    {
        ...
        default:self.title = @"Unsupported";break;
